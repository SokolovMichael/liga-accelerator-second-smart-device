...
var formFieldset = document.querySelector('.form__fieldset');
var formItemTel = formFieldset.querySelector('.form__item--tel');
var formWrapper = formFieldset.querySelector('.form__wrapper');
var sendFormButton = formWrapper.querySelector('button');
var formFieldsetPopup = document.querySelector('.form-popup__fieldset');
var formItemTelPopup = formFieldsetPopup.querySelector('.form-popup__item--tel');
var sendFormButtonPopup = formFieldsetPopup.querySelector('button');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _open_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./open-modal.js */ "./js/open-modal.js");
/* harmony import */ var _scroll_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scroll.js */ "./js/scroll.js");
/* harmony import */ var _show_about_text_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./show-about-text.js */ "./js/show-about-text.js");
/* harmony import */ var _input_tel_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./input-tel.js */ "./js/input-tel.js");
/* harmony import */ var _open_menu_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./open-menu.js */ "./js/open-menu.js");





Object(_open_modal_js__WEBPACK_IMPORTED_MODULE_0__["openModal"])();
Object(_scroll_js__WEBPACK_IMPORTED_MODULE_1__["scrollTo"])();
Object(_show_about_text_js__WEBPACK_IMPORTED_MODULE_2__["showAboutText"])();
Object(_input_tel_js__WEBPACK_IMPORTED_MODULE_3__["inputTel"])();
Object(_open_menu_js__WEBPACK_IMPORTED_MODULE_4__["openMenu"])();
...
var chapter = document.querySelector('.footer__chapter');
var chapterButton = chapter.querySelector('button');
var chapterList = chapter.querySelector('.chapter__list');
var footerContacts = document.querySelector('.footer__contacts');
var footerContactsButton = footerContacts.querySelector('button');
var footerContactsList = footerContacts.querySelector('.footer-contacts__list');

var onCloseChapterMenu = function onCloseChapterMenu() {
...
var onShowChapterMenu = function onShowChapterMenu() {
...
var onCloseFooterContactsMenu = function onCloseFooterContactsMenu() {
...
var onShowFooterContactsMenu = function onShowFooterContactsMenu() {
...
/* harmony import */ var _utils_is_escape_key_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/is-escape-key.js */ "./js/utils/is-escape-key.js");
...
var openModalWindowButton = nav.querySelector('button');
var modal = document.querySelector('.modal');
var closeModalWindowButton = modal.querySelector('button[type="button"]');
var formPopupInput = modal.querySelector('input[type="text"]');
var focusTrap = Object(focus_trap__WEBPACK_IMPORTED_MODULE_1__["createFocusTrap"])('#modal', {
...
var onModalWindowOpen = function onModalWindowOpen() {
...
var onModalWindowClose = function onModalWindowClose() {
...
var onModalWindowEscKeydown = function onModalWindowEscKeydown(evt) {
  if (Object(_utils_is_escape_key_js__WEBPACK_IMPORTED_MODULE_0__["isEscapeKey"])(evt)) {
    evt.preventDefault();
    onModalWindowClose();
  }
};

var onModalWindowOutsideClickClose = function onModalWindowOutsideClickClose(evt) {
...
var about = document.querySelector('.about__wrapper');
var aboutButton = about.querySelector('button');
var aboutItemHidden = about.querySelectorAll('.about__item--hidden');
var aboutItemSuppliers = about.querySelector('.about__item--suppliers');

var onShowAboutText = function onShowAboutText() {
  for (var i = 0; i < aboutItemHidden.length; i++) {
...
var onCloseAboutText = function onCloseAboutText() {
  for (var i = 0; i < aboutItemHidden.length; i++) {
